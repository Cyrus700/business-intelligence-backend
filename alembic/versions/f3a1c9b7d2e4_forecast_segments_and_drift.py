...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_model_version", "ml_models", ["model_type", "target", "dimensions", "version"])
    op.drop_constraint("uq_forecast_point", "forecasts", type_="unique")
    op.create_unique_constraint("uq_forecast_point", "forecasts", ["model_id", "target", "dimensions", "forecast_date"])


def downgrade() -> None:
    op.drop_constraint("uq_forecast_point", "forecasts", type_="unique")
    op.create_unique_constraint("uq_forecast_point", "forecasts", ["model_id", "target", "forecast_date"])
    op.drop_constraint("uq_model_version", "ml_models", type_="unique")
    op.create_unique_constraint("uq_model_version", "ml_models", ["model_type", "target", "version"])
