...
MIN_ROLE: dict[tuple[str, str], str | None] = {
    ...
    ("GET", "/api/v1/advanced/heatmap"): "analyst",
    ("GET", "/api/v1/advanced/scatter"): "analyst",
    ("GET", "/api/v1/advanced/funnel"): "analyst",
    ("GET", "/api/v1/advanced/radar"): "analyst",
    ("GET", "/api/v1/advanced/small-multiples"): "analyst",
    ("GET", "/api/v1/advanced/key-influencers"): "analyst",
    ("GET", "/api/v1/advanced/segmentation"): "analyst",
    ("GET", "/api/v1/advanced/forecast-scenarios"): "analyst",
    ("GET", "/api/v1/advanced/model-comparison"): "analyst",
    # admin endpoints
    ...
    ("GET", "/api/v1/admin/email/status"): "admin",
    ("POST", "/api/v1/admin/email/test"): "admin",
    ("GET", "/api/v1/admin/workers/status"): "admin",
    ("GET", "/api/v1/admin/workers/runs"): "admin",
    # admin-only reads
